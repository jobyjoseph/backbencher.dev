...
description: JavaScript is known to be as prototype-based language. Prototype helps to implement inheritance concept in JavaScript.
tags: ["javascript"]
---

import imagePrototypeProperty from "./images/prototype-property.png";
import imageDuntoProto from "./images/__proto__.png";
import imageDuntoProto1 from "./images/__proto__1.png";
import imageDuntoProto2 from "./images/__proto__2.png";
...
<Image
  src={imagePrototypeProperty}
  style={{ "max-width": "300px" }}
  alt="Prototype Property"
  caption="Prototype Property"
/>
...
<Image src={imageDuntoProto} style={{ "max-width": "300px" }} />

Now print the value of `obj.__proto__` in console.

<Image src={imageDuntoProto1} style={{ "max-width": "300px" }} />
