...
decription: Learn in depth about promises in JavaScript. How a promise can be created and consumed.
tags: ["javascript"]
---

import Image from "../../../../src/components/image";
import imagePromiseAllSettled from "./images/promise-allsettled.png";
import imagePromise from "./images/promises-1.png";
...
<Image
  src={imagePromise}
  alt="Contents of promise instance"
  caption="Contents of promise instance"
...
<Image
  src={imagePromiseAllSettled}
  alt="Promise.allSettled()"
  caption="Output: Promise.allSettled()"
