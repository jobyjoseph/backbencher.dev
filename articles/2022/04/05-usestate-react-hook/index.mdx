...
Above code sets `"orange"` as the default color. On click of the button, the state value is changed to `"red"`. You can try the code online in [codesandbox](https://codesandbox.io/s/react-hooks-idcwej?from-embed).
