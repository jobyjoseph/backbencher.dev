...
import imgFunction from "./images/function.png";
import imgFunctionError from "./images/function-error.png";
...
<Image src={imgFunction} alt="Function" style={{ maxWidth: "500px" }} />
...
<Image src={imgFunctionError} alt="Function" style={{ maxWidth: "600px" }} />
