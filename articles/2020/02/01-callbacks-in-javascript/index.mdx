...
description: Callbacks are functions that are passed as arguments to another functions. A function that receives a callback function as its argument is called Higher Order Function
tags: ["javascript"]
---
...
So we can conclude that callback hell is due to inversion of control in callbacks. The JavaScript community came up with a solution for inversion of control problem and that is _Promises_.
